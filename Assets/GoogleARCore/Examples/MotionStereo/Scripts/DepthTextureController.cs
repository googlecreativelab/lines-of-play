//-----------------------------------------------------------------------
// <copyright file="DepthTextureController.cs" company="Google">
//
...
public class DepthTextureController : MonoBehaviour
{
    ...
    public void Attach()
    {
        ...
        {
            material.SetTexture(k_CurrentDepthTexturePropertyName, m_DepthTexture);
    ...
    private void Update()
    {
        ...
        if (UseSparseDepth)
        {
            //Frame.CameraImage.UpdateSparseDepthTexture(ref m_DepthTexture, true);
        }
        else
        {
