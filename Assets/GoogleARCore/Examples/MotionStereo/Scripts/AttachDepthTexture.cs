//-----------------------------------------------------------------------
// <copyright file="AttachDepthTexture.cs" company="Google">
//
...
public class AttachDepthTexture : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (UseSparseDepth == true)
        {
            if (ReprojectIntermediateSparseDepth)
            {
                //Frame.CameraImage.UpdateSparseDepthTexture(
                //    ref m_DepthTexture, ReprojectIntermediateSparseDepth);
            }
        }
        else
        {
