    ...
    public class PlaneDiscoveryGuide : MonoBehaviour
    {
        ...
        public void EnablePlaneDiscoveryGuide(bool guideEnabled)
        {
            ...
            else
            {
                ...
                //print("mainUI - true -EnablePlaneDiscoveryGuide ");
            }
        }
        ...
        private void _OnOpenButtonClicked()
        {
            ...
            m_SnackBar.SetActive(false);
            //mainUI.SetActive(true);
            //print("mainUI - true -_OnOpenButtonClicked ");
        }
        ...
        private void _UpdateUI()
        {
            ...
            else if (m_IsLostTrackingDisplayed)
            {
                ...
                m_SnackBar.SetActive(false);
                //mainUI.SetActive(true);
                //print("mainUI - true - if (m_IsLostTrackingDisplayed) ");
                m_IsLostTrackingDisplayed = false;
            }
            ...
            if (m_NotDetectedPlaneElapsed > DisplayGuideDelay)
            {
                ...
                m_SnackBar.SetActive(true);
                //mainUI.SetActive(false);
                //print("mainUI - false - if (m_NotDetectedPlaneElapsed > DisplayGuideDelay) ");
            ...
            else if (m_NotDetectedPlaneElapsed > 0f || m_DetectedPlaneElapsed > k_HideGuideDelay)
            {
                ...
                if (!isUIEnabled)
                {
                    print("mainUI - true - if (m_NotDetectedPlaneElapsed > 0f ");
                    //mainUI.SetActive(true);
                    isUIEnabled = true;
                }
