//-----------------------------------------------------------------------
// <copyright file="MotionStereoDepthDataSource.cs" company="Google">
//
...
/// </summary>
/// TODO(b/123936384): Verify texture resizing doesn't cause garbage allocations.
public class MotionStereoDepthDataSource : IDepthDataSource
{
    private short[] m_DepthArray = new short[0];
    private byte[] m_ConfidenceArray = new byte[0];
    ...
    {
        _UpdateTexture(ref confidenceTexture, ref m_ConfidenceArray, _AcquireDepthImage);
    }
    ...
    {
        _UpdateDepthArray(ref m_ConfidenceArray, _AcquireDepthImage);
        return m_ConfidenceArray;
    }
    ...
    {
        // Get the current depth image.
        ApiArStatus status = (ApiArStatus)ExternApi.ArFrame_acquireDepthImage_private(
            sessionHandle,
            frameHandle,
...
#pragma warning disable 626
        ...
        public static extern ApiArStatus ArFrame_acquireDepthImage_private(
        ...
        [AndroidImport(ApiConstants.ARCoreNativeApi)]
        public static extern void ArFrame_containsNewDepthMeasurement(
            IntPtr sessionhandle, IntPtr frameHandle, ref int containsNewMeasurement);

        [AndroidImport(ApiConstants.ARCoreNativeApi)]
        public static extern ApiArStatus ArFrame_acquireDepthConfidenceImage(
            IntPtr sessionHandle, IntPtr frameHandle, ref IntPtr imageHandle);
