//-----------------------------------------------------------------------
// <copyright file="DepthSource.cs" company="Google">
//
...
public class DepthSource : MonoBehaviour
{
    ...
    private static bool s_UpdateConfidence;
    private static bool s_AlwaysUpdateDepth;
    private static bool s_AlwaysUpdateConfidence;
    ...
    public static Texture2D ConfidenceTexture
    {
        get
        {
            ...
            if (!(s_UpdateDepth || s_UpdateConfidence))
            {
                s_DepthDataSource.UpdateConfidenceTexture(ref s_ConfidenceTexture);
                s_UpdateConfidence = true;
            }
    ...
    public static byte[] ConfidenceArray
    {
        get
        {
            ...
            if (!s_UpdateDepth)
            {
                s_DepthDataSource.UpdateConfidenceArray();
            }

            return s_DepthDataSource.ConfidenceArray;
        }
    }
    ...
    public static bool AlwaysUpdateConfidence
    {
        get
        {
            return s_AlwaysUpdateConfidence;
        }

        set
        {
            s_AlwaysUpdateConfidence = value;
        }
    }
    ...
    {
        return s_DepthDataSource.GetRegionConfidence(region);
    }
    ...
    private void Start()
    {
        ...
        s_ConfidenceTexture = new Texture2D(2, 2);

        s_DepthTexture.filterMode = FilterMode.Bilinear;
        s_ConfidenceTexture.filterMode = FilterMode.Point;

        s_DepthTexture.wrapMode = TextureWrapMode.Clamp;
        s_ConfidenceTexture.wrapMode = TextureWrapMode.Clamp;
    ...
    private void Update()
    {
        ...
        s_UpdateConfidence = s_UpdateDepth || s_AlwaysUpdateConfidence;
     

        if (s_UpdateConfidence)
        {
