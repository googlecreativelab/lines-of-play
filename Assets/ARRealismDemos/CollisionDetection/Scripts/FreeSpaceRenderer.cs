//-----------------------------------------------------------------------
// <copyright file="FreeSpaceRenderer.cs" company="Google">
//
...
namespace GoogleARCore.Examples.FreeSpaceRenderer
{
    ...
    public class FreeSpaceRenderer : MonoBehaviour
    {
        ...
        /// <summary>
        /// Prints the per-pixel depth value in the debug console.
        /// </summary>
        public bool PrintPerPixelDepth = false;
        ...
        protected void Start()
        {
            ...
            DebugPanel.Instance.Print("Please tap on a plane for free space visualization." +
                m_BoundingBoxVertices[7]);
        ...
        private void RenderFreeSpace()
        {
            ...
            DebugPanel.Instance.Print("World: " + worldPosition +
                " | Screen: " + screenPosition + "\n" +
                " Converted: " + ComputeVertexInWorldSpace(normalizedScreenPoint) +
                " | Explored: " + (IsWorldRegionExplored(worldPosition) ? "1" : "0") +
                " | Hash: " + GetWorldPointHashId(worldPosition) +
                " | Quads: " + totalQuads);
            m_IsRendering = false;
        }
        ...
        {
            Debug.Log("Updates the free space.");
        }
        ...
        private bool IsScreenPointRegionExplored(Vector2 normalizedScreenPosition)
        {
            ...
            Debug.Log("IsScreenPointRegionExplored: " + normalizedScreenPosition + " => " + hashId
                + ", " + m_ScreenSpaceMap[hashId]);
        ...
        private int GetWorldPointHashId(Vector3 position)
        {
            ...
            Debug.Log("GetWorldPointHashId: " + position + " => " + hashId);
            return hashId;
        }
        ...
        private float FetchEnvironmentDepth(Vector3 screenPosition)
        {
            ...
            if (PrintPerPixelDepth)
            {
                DebugPanel.Instance.Print("X:" + depthX + " Y:" + depthY + " Virtual Depth:" +
                  screenPosition.z + " Real Depth:" + result);
            }
